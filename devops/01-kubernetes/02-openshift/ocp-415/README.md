...
│   │       ├── New features and enhancements (such as OpenShift AI integrations)
...
│   │       └── Master node components and topology (including Hosted Control Planes updates)
│   └── support
│       ├── Support overview
...
│   │       └── Mirroring the OpenShift release images using oc-mirror v2
...
│   │       ├── Understanding OpenShift software-defined networking (OVN-Kubernetes default)
│   │       └── Choosing a network plugin provider
...
│   │       └── Forwarding cluster logs to external systems (Elasticsearch, Kafka, Splunk) via Vector Engine
